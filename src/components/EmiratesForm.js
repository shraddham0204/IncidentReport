...
import { View, Text, ScrollView, PixelRatio, TouchableOpacity, Image } from 'react-native';
...
class EmiratesForm extends Component {
    ...
    render() {
        ...
        return (<ScrollView style={{ backgroundColor: 'white' }}>
         ...
         <DateCustom selected_date={this.state.select_date} selected_time={this.state.select_time} title="Date of Occurrence" max_date={this.state.maxDate} onDateChangee={this._changeDate} onSelectTime={this._selectedTime}/>
         ...
         <InputArea label="Event Title" placeholder="Event Title" onChangeText={this._eventTitle} value={this.state.eventTitle} numberOfLines={20} multiline={false}/>
         <InputArea label="Event Details" placeholder="Event Details" onChangeText={this._eventDetails} value={this.state.eventDetails} numberOfLines={60} multiline={true}/>
        ...
        <RadioButton title="Injured Person" event_types={injured_person} onRadioChange={this.handleInjuredPerson}/>
        <InputArea label="Name" placeholder="Name" onChangeText={this._name} value={this.state.name} numberOfLines={10} multiline={false}/>
