  ...
  console.error(error);
    ...
    render() {
        return (
          ...
          {/*<TouchableOpacity onPress = {this.onNmissPress.bind(this)} style={styles.ButtonStyle} >
          <Text style={styles.TextStyle}>
         Report Near Miss
          </Text>
        </TouchableOpacity>*/}
          ...
          <Image       
          source={require('./Images/MetricStreamLogo.png')} 
          resizeMode="cover"
          />
          </View>
          </View >
