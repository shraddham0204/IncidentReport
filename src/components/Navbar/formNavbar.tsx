import {
    View, Image, StatusBar,Text,TouchableOpacity,AsyncStorage,Alert,NetInfo
   } from 'react-native';
   ...
   class FormNavbar extends Component {
       ...
       Alert.alert(
        'Event Saved',
        'You are currently offline! This Event is auto-saved and can be synchronized when you go online.',
        [
