import { View, Image, StatusBar, Text, TouchableOpacity, AsyncStorage, Alert } from 'react-native';
                ...
                this.state.data.map((loop_data) => {
                    ...
                    fetch(`${URL}/metricstream/m2/api/7.0/emr/submitData/`, {
                        ...
                        if (response.status == 200) {
                            ...
                            Alert.alert('Network Error', 'We Experienced a network error please sync again', [
                                { text: 'OK' },
                            ], { cancelable: false });
                        }
                    })
        ...
        return (<View style={styles.backgroundStyle}>
         ...
         <Image source={require('../Images/back-button.png')} style={styles.logoutStyle}/>
          ...
          <TouchableOpacity onPress={this._onPressButton}>
            <Image source={require('../Images/sync.png')} style={styles.logoutStyle}/>
            </TouchableOpacity>
       </View>
   </View>);
    }
