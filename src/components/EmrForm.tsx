...
import {View,Text,ScrollView,Picker,PixelRatio,TouchableOpacity,Image} from 'react-native';
    ...
    render() {
        ...
        return (
         <ScrollView style={{backgroundColor:'white'}}>
                ...
                />
                <DateCustom selected_date={this.state.select_date} selected_time={this.state.select_time} title="Date of Occurrence" max_date={this.state.maxdate1}
